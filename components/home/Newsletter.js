        ...
        <div className="w-full flex flex-col gap-6">
            ...
            <div className="relative flex text-gray-500">
                    <Input
                        ...
                        autoComplete="off"
                        autoFocus
                        className="text-md border-0 text-xs rounded-2xl w-full bg-gray-100 focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 focus:outline-none focus:placeholder-gray-400 py-2"
                        value={inputValue}
