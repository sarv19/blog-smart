...
export default function NavBar() {
  ...
  return (
    <>
      <div
        className={`fixed top-0 flex w-full justify-center px-5 md:px-10 lg:px-14 border-b border-gray-200/60 bg-white ${scrolled
                ...
                <HoverCard openDelay={0}>
                  ...
                  <HoverCardContent className="flex flex-col text-xs p-1 w-[150px] text-gray-600">
                    {/* <Dialog>
                      ...
                      > */}
                    <div className="flex items-center gap-2 py-3 px-4 hover:bg-gray-100 cursor-pointer" onClick={() => setIsOpen(true)}>
                      <Settings
                        width={15}
                        height={15}
                      />
