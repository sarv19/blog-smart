...
const Footer = () => {
    return (
        <div className="relative flex flex-col items-center border-t gap-4 pt-10 pb-20 md:pb-32 text-xs overflow-hidden">
            ...
            <p
                className={`font-medium text-2xl tracking-widest ${caveat.className}`}
            >
                TechWave
            </p>
            ...
            >
                <img
                    ...
                    loading="lazy"
                    alt=""
                    className="w-[5em] h-[5.8em] absolute -bottom-8 hover:bottom-0 transition-all duration-300 ease-in-out"
                />
            </Link>
        </div>
    );
